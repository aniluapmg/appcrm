...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post prospects_url, params: { prospect: { email: @prospect.email, last_name: @prospect.last_name, name: @prospect.name, phone: @prospect.phone, status: @prospect.status } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { email: @prospect.email, last_name: @prospect.last_name, name: @prospect.name, phone: @prospect.phone, status: @prospect.status } }
